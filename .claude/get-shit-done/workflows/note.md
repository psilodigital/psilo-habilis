...
- **Global scope**: `/Users/andreesteves/Documents/projects/habilis/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/andreesteves/Documents/projects/habilis/.claude/notes/`)
...
2. Glob `/Users/andreesteves/Documents/projects/habilis/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/andreesteves/Documents/projects/habilis/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/andreesteves/Documents/projects/habilis/.claude/notes/` — works in any directory

...
```bash
INIT=$(node "/Users/andreesteves/Documents/projects/habilis/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/andreesteves/Documents/projects/habilis/.claude/get-shit-done/templates/spec.md.

...
```
Task(
  prompt="Read /Users/andreesteves/Documents/projects/habilis/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreesteves/Documents/projects/habilis/.claude/get-shit-done/templates/SECURITY.md`
